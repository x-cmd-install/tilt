...
[![x-cmd/install — tilt Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/tilt.svg?lang=zh)](https://x-cmd.com/install/tilt)
...
合计: **2,005,633** 行代码（覆盖前 5 种语言、共 **10059** 个文件）。
...
- **Star**: 10,069 · **Fork**: 412 · **开放 issue**: 1,591 · **贡献者**: 115

## 累计统计

- **发布数**: 265 · **已合并 PR**: 4939 · **开放 PR**: 10 · **已关闭 issue**: 1094 · **开放 issue**: 497 · **提交数**: 5103

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 6 | 0 | 0 | 0 | 5 |
| last60d | 2026-07-26 | 2 | 15 | 4 | 3 | 2 | 16 |
| 90d | 2026-06-26 | 3 | 34 | 5 | 5 | 4 | 43 |
| last180d | 2026-03-28 | 7 | 70 | 9 | 9 | 5 | 77 |
| 360d | 2025-09-29 | 12 | 140 | 10 | 35 | 14 | 149 |
| last720d | 2024-10-04 | 22 | 216 | 10 | 83 | 49 | 238 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/tilt.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:50:22Z._
